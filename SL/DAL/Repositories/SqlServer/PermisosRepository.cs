...
namespace SL.DAL.Repositories.SqlServer
{
    public class PermisosRepository
    {
        ...
        public IList<PatenteEntity> GetAllPatentes()
        {
            ...
            var lista = new List<PatenteEntity>();
            ...
            while (reader.Read())
            {
                ...
                PatenteEntity c = new PatenteEntity();
        ...
        public IList<FamiliaEntity> GetAllFamilias()
        {
            ...
            var lista = new List<FamiliaEntity>();
            ...
            while (reader.Read())
            {
                ...
                FamiliaEntity c = new FamiliaEntity();
        ...
        public IList<ComponenteEntity> GetAll(string familia)
        {
            ...
            var lista = new List<ComponenteEntity>();
        ...
        private ComponenteEntity GetComponent(int id, IList<ComponenteEntity> lista)
        {

            ComponenteEntity component = lista != null ? lista.Where(i => i.Id.Equals(id)).FirstOrDefault() : null;
